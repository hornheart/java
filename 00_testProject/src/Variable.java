...
public class Variable {
	/*
	 * 변수의 선언
	 * 값을 기록하기위한 변수를 메모리 공간에 확보, 할당하나. -> 즉, 값을 보관하기위한 공간을 만든다고 생각하면 된다.
	 * 
	 * [표현법] 자료형 변수이름;
	 * 
	...
	public static void main(String[] args) {
		...
		//boolean(참과거짓)이라는 자료현으로 isTrue라는 이름의 변수를 선언
		boolean isTrue;
		
		// float(실수)이라는 자료현으로 num20라는 이름의 변수를 선언	
		float num20;
